<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyReport.aspx.cs" Inherits="Admin_MonthlyReport" %>
...
<body>
    ...
    <div align="center">
     年份：   <asp:DropDownList runat="server" ID="dropYear" Width="204px" Font-Size="Medium">
                        ...
                        月份： <asp:DropDownList runat="server" ID="dropMonth" Width="204px" Font-Size="Medium">
                        </asp:DropDownList>&nbsp;&nbsp;&nbsp;
