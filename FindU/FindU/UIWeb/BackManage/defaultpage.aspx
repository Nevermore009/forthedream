    ...
    <div id="mainFrame">
                    ...
                    <div id="bs_bannerright">
                        ...
                        <div class="bs_nav">
                            <div class="bs_navleft">
                                <ul>
                                    <li>尊敬的[<%=Session["realname"]%>],欢迎登录系统,今天是
                            ...
                            <div class="bs_navright">
                                <span style="background: url(../images/icons/home.gif) no-repeat left center; padding-left: 25px;">
                                 <a href="../Admin/defaultpage.aspx" style="text-decoration:none">用户主页</a></span>
                                ...
                                <div id="rbox_middleright">
                                    <div id="bs_right">
                                        <iframe scrolling="yes" width="100%" frameborder="0" id="frmright" name="frmright"
                                            src="../Admin/open.aspx" allowtransparency="true"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="fbox">
            <div id="bs_footcenter">
                <div id="bs_footleft">
                    <div id="bs_footright">
                        Copyright 2012 @ 中国移动通信常德分公司版权所有 技术支持：常德市奥凯信息技术研究所
                    </div>
                </div>
            </div>
        </div>
