...
namespace Bll
{
    public class BTravelDetail
    {
        ...
        {
            return new DLL.TravelDetail().add(serialno,title, description, generalprice, adultprice, childprice,isfixed, startdate, enddate, departuretime, features, billinclude, billbeside, servicestandard, presentation, journey, contact, traveltypeid, journeydays, transportation, adultruleid, childruleid);
        }
        ...
        {
            return new DLL.TravelDetail().update(serialno,title, description, generalprice, adultprice, childprice,isfixed, startdate, enddate, departuretime, features, billinclude, billbeside, servicestandard, presentation, journey, contact, journeydays, transportation, adultruleid, childruleid, id);
        }
