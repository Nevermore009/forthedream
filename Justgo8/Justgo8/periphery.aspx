<%@ Page Title="" Language="C#" MasterPageFile="~/IndexMaster.master" AutoEventWireup="true"
    CodeBehind="periphery.aspx.cs" Inherits="Justgo8.periphery" %>
                ...
                <div id="outland_bottom_Left">
                    <ul class="outland_bottom_Left_ul1">
                        <asp:Repeater runat="server" ID="RepeaterOutland">
                            <ItemTemplate>
                                <li class="li_x"><a href="search.aspx?traveltype=<%=Bll.BTravelType.Periphery %>&areaid=<%#Eval("areaid") %>" target="_blank">
                                    <%#Eval("areaname") %></a></li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
