<%@ Page Title="" Language="C#" MasterPageFile="~/IndexMaster.master" AutoEventWireup="true"
    CodeBehind="zyx.aspx.cs" Inherits="Justgo8.zyx" %>
    ...
    <div id="outland">
        ...
        <div id="route">
            您当前所在位置：<a href="index.aspx">首页</a>&nbsp;->&nbsp;<a href="###" target="_parent"><font
                color="#cd0007">自由行</font></a></div>
        <div class="clear">
        </div>
        <div id="outland_bottom">
            <div id="outland_bottomTop">
                <div class="outland_bottomTop_left">
                    <img src="images/index/zyx.png" width="200px" height="30px" alt="" /></div>
                <div class="outland_bottomTop_right">
                    <a href="search.aspx?traveltype=<%=Bll.BTravelType.Zyx %>" target="_blank" class="more">
                        更多&gt;&gt;</a></div>
            </div>
            <div class="clear">
            </div>
                ...
                <div id="outland_bottom_Left">
                    <ul class="outland_bottom_Left_ul1">
                        <asp:Repeater runat="server" ID="RepeaterZyx">
                            <ItemTemplate>
                                <li class="li_x"><a href="search.aspx?traveltype=<%=Bll.BTravelType.Zyx %>&areaid=<%#Eval("areaid") %>"
                                    target="_blank">
                                    <%#Eval("areaname") %></a></li>
                            </ItemTemplate>
                        </asp:Repeater>
                                    ...
                                    <li><a href='detail.aspx?id=<%#Eval("id") %>' target="_blank"><span>
                                        <img src='<%#Eval("pic") %>' width="167px" height="105px" alt='<%#Eval("title") %>'
                                            title="<%#Eval("title") %>" /></span><span style="text-align: center;"><%#Eval("title") %>(<%#Eval("description") %>)</span><span
                                                class="outland_bottom_Right_ul1_price">
                                                RMB<%#Eval("adultprice") %>元</span></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    </div>
