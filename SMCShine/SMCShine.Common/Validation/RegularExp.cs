...
namespace SMCShine.Common
{
    ...
    public static class RegularExp
    {
        ...
        /// 匹配手机号
        /// </summary>
        public static readonly string Mobile = @"^(13|14|15|16|18)\d{9}$";

        /// <summary>
        ///  匹配手机号包括外省的号码
        /// </summary>
        public static readonly string FullMobile = @"^(0)?(13|14|15|16|18)\d{9}$";

        /// <summary>
        ///  移动号码
        /// </summary>
        public static readonly string mobileTel = @"^(134|135|136|137|138|139|147|150|151|152|154|157|158|159|182|183|184|187|188)\d{8}$";

        /// <summary>
        /// 联通号码
        /// </summary>
        public static readonly string unicomTel = @"^(130|131|132|155|156|185|186)\d{8}$";

        /// <summary>
        /// 电信号码
        /// </summary>
        public static readonly string telecomTel = @"^(133|153|180|181|189)\d{8}$";

    
        /// <summary>
        /// 匹配多个手机号形如130xxxxxxx0,130xxxxxxx1
        /// </summary>
        public static readonly string MultipMobile = @"^((13|14|15|16|18)\d{9},)*((13|14|15|16|18)\d{9})$";
