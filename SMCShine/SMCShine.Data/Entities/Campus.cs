...
namespace SMCShine.Data.Entities
{
    ...
    [Table(Name = "dbo.Campus")]
    public class Campus : INotifyPropertyChanging, INotifyPropertyChanged
    {
        private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);

        private Guid guid = Guid.Empty;
        private string name = string.Empty;
        private string campusCode = string.Empty;
        ...
        ///</summary>
        [DataMember]
        [Column(Storage = "campusCode", Name = "CampusCode", DbType = "nvarchar", IsVersion = false, CanBeNull = false, UpdateCheck = UpdateCheck.Never)]
        public string CampusCode
        {
            ...
            set
            {
                if (this.campusCode != value || value == string.Empty)
                {
                    this.SendPropertyChanging();
