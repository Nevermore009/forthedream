...
namespace SMCShine.Data.Entities
{
    ...
    [Table(Name = "dbo.ClassType")]
    public class ClassType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        ///</summary>
        [DataMember]
        [Column(Storage = "classID", Name = "ClassID", DbType = "nvarchar", IsVersion = false, CanBeNull = false, UpdateCheck = UpdateCheck.Never)]
        public string ClassID
        {
            ...
            set
            {
                if (this.classID != value || value == string.Empty)
                {
                    this.SendPropertyChanging();
                    this.classID = value;
        ...
        ///</summary>
        [DataMember]
        [Column(Storage = "classification", Name = "Classification", DbType = "nvarchar", IsVersion = false, CanBeNull = true, UpdateCheck = UpdateCheck.Never)]
        public string Classification
        {
            ...
            set
            {
                if (this.classification != value || value == null)
                {
                    this.SendPropertyChanging();
