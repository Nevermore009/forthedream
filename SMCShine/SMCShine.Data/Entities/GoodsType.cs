...
namespace SMCShine.Data.Entities
{
    ...
    [Table(Name = "dbo.GoodsType")]
    public class GoodsType : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<GoodsItem> goodsItems;

        public GoodsType()
        {
            this.goodsItems = new EntitySet<GoodsItem>(new Action<GoodsItem>(this.attach_GoodsItem), new Action<GoodsItem>(this.detach_GoodsItem));
        }
        ...
        ///所有
        ///</summary>
        [Association(Storage = "goodsItems", Name = "GoodsType_GoodsItem", ThisKey = "Guid", OtherKey = "GoodsTypeGuid")]
        public EntitySet<GoodsItem> GoodsItems
        {
            get
            {
        ...
        private void attach_GoodsItem(GoodsItem entity)
        {
            this.SendPropertyChanging();
            entity.GoodsType = this;
        }

        private void detach_GoodsItem(GoodsItem entity)
        {
            this.SendPropertyChanging();
