...
namespace SMCShine.Data.Entities
{
    ...
    public class UserGroup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private string permisionXml = null;
        ...
        public UserGroup()
        {
            this.users = new EntitySet<User>(new Action<User>(this.attach_User), new Action<User>(this.detach_User));
        }
        ...
        ///</summary>
        [DataMember]
        [Column(Storage = "permisionXml", Name = "PermisionXml", DbType = "xml", IsVersion = false, CanBeNull = true, UpdateCheck = UpdateCheck.Never)]
        public string PermisionXml
        {
            get
            {
                return this.permisionXml;
            }
            set
            {
                if (this.permisionXml != value || value == null)
                {
                    this.SendPropertyChanging();
                    this.permisionXml = value;
                    this.SendPropertyChanged("PermisionXml");
                }
            }
        }
        ...
        ///所有
        ///</summary>
        [Association(Storage = "users", Name = "UserGroup_User", ThisKey = "Guid", OtherKey = "UserGroupGuid")]
